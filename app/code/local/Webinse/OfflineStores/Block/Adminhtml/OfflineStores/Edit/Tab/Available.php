 ...
 */
class Webinse_OfflineStores_Block_Adminhtml_Offlinestores_Edit_Tab_Available extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    {
        $products = array();
        foreach (Mage::registry('current_offlinestore')->getRelatedProducts() as $product) {
