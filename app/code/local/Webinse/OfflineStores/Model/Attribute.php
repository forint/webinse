<?php
class Webinse_OfflineStores_Model_Attribute extends Mage_Eav_Model_Entity_Attribute {

    const SCOPE_STORE                           = 0;
    const SCOPE_GLOBAL                          = 1;
    const SCOPE_WEBSITE                         = 2;
    const MODULE_NAME                           = 'Webinse_OfflineStores';
    const ENTITY                                = 'webinse_offlinestores_eav_attribute';

    protected $_eventPrefix                     = 'webinse_offlinestores_entity_attribute';
    protected $_eventObject                     = 'attribute';

    static protected $_labels                   = null;

    protected function _construct(){
        $this->_init('webinseofflinestores/attribute');
    }
