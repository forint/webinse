<?php
class Webinse_OfflineStores_Helper_Image extends Mage_Core_Helper_Abstract
{
     ...
     * @return Mage_Catalog_Helper_Image
     */
    public function init(Webinse_OfflineStores_Model_Offlinestore $offlineStore, $attributeName, $imageFile=null)
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('webinseofflinestores/offlinestore_image'));
        ...
        if ($imageFile) {
            ...
            Mage::Log($this->getOfflineStore()->getData(),null,'offlinestore_data_before_load_image.log');
            die;
            // add for work original size
            var_dump($this->getOfflineStore()->getData($this->_getModel()->getDestinationSubdir()));die;
            $this->_getModel()->setBaseFile($this->getOfflineStore()->getData($this->_getModel()->getDestinationSubdir()));
        }
        return $this;
    }
     ...
     * @return Mage_Catalog_Helper_Image
     */
    protected function setOfflineStore($offlineStore)
    {
    ...
    /**
     * Get current offline store
     *
     * @return Webinse_OfflineStores_Model_Offlinestore
     */
    protected function getOfflineStore()
    {
