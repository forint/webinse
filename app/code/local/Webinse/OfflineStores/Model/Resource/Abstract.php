<?php
/**
 * Offline store entity abstract model
 */
abstract class Webinse_OfflineStores_Model_Resource_Abstract extends Mage_Eav_Model_Entity_Abstract
{
    /**
    ...
    {
        return 'webinseofflinestores/resource_eav_attribute';
    }
