<?php
class Webinse_OfflineStores_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    const SCOPE_STORE                           = 0;
    ...
    const ENTITY                                = 'offlinestore_attribute';
     ...
     * @var string
     */
    protected $_eventPrefix                     = 'offlinestore_entity_attribute';
    /**
     * Event object name
     *
     * @var string
